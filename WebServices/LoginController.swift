...
public class LoginController{
    ...
    func getLogin(generarCodigoMovilSMS: LoginAplicacionMovil ,completion: @escaping (_ res:ObjectLogin?, String?) -> Void) {
        ...
        loginAplicacionMovil.cpPasswordApi = "passwordWSjjj"
